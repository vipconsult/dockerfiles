...
docker run --name nginx --restart=always -d -v /home/http:/home/http -v /var/run:/var/run -p 178.79.150.62:80:80 -p 178.79.150.62:443:443 vipconsult/nginx nginx -c /home/http/default/main.conf -g "daemon off;"
