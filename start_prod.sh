...
docker run --name psql1 --restart=always -d -p 127.0.0.1:5432:5432 -v /home/postgresql:/var/lib/postgresql/data -e PG_LOCALE="en_GB.UTF-8 UTF-8" vipconsult/pgsql93

docker run --name php53 --restart=always -d -v /var/run:/var/run -v /home/http:/home/http  --link mysql1:mysql1  --link psql1:psql1 vipconsult/php53

docker run --name php --restart=always -d -v /var/run:/var/run -v /home/http:/home/http  --link mysql1:mysql1  --link psql1:psql1 vipconsult/php
